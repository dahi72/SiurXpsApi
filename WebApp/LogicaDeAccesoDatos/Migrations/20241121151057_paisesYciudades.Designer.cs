...
namespace LogicaDeAccesoDatos.Migrations
{
    ...
    [Migration("20241121151057_paisesYciudades")]
    partial class paisesYciudades
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CiudadGrupoDeViaje", b =>
                {
                    b.Property<int>("CiudadesDestinoId")
                        .HasColumnType("int");

                    b.Property<int>("GrupoDeViajeId")
                        .HasColumnType("int");

                    b.HasKey("CiudadesDestinoId", "GrupoDeViajeId");

                    b.HasIndex("GrupoDeViajeId");

                    b.ToTable("GrupoDeViajeCiudadesDestino", (string)null);
                });

            modelBuilder.Entity("GrupoDeViajePais", b =>
                {
                    b.Property<int>("GrupoDeViajeId")
                        .HasColumnType("int");

                    b.Property<int>("PaisesDestinoId")
                        .HasColumnType("int");

                    b.HasKey("GrupoDeViajeId", "PaisesDestinoId");

                    b.HasIndex("PaisesDestinoId");

                    b.ToTable("GrupoDeViajePaisesDestino", (string)null);
                });
            ...
            modelBuilder.Entity("LogicaNegocio.Dominio.GrupoDeViaje", b =>
                {
                    ...
                    b.Property<string>("CiudadesDestinoIds")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PaisesDestinoIds")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CiudadGrupoDeViaje", b =>
                {
                    b.HasOne("LogicaNegocio.Dominio.Ciudad", null)
                        .WithMany()
                        .HasForeignKey("CiudadesDestinoId")
