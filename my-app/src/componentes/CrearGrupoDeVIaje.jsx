...
const CrearGrupoDeViaje = () => {
  ...
  // Actualizar las ciudades cuando cambia el país seleccionado
  useEffect(() => {
    if (paisSeleccionado) {
  ...
  const handleAddPais = () => {
    if (paisSeleccionado && !paisesSeleccionados.find(p => p.id === paisSeleccionado.id)) {
      setPaisesSeleccionados([...paisesSeleccionados, paisSeleccionado]);
  ...
  const handleAddCiudad = () => {
    if (ciudadSeleccionada && !ciudadesSeleccionadas.find(c => c.id === ciudadSeleccionada.id)) {
      setCiudadesSeleccionadas([...ciudadesSeleccionadas, ciudadSeleccionada]);
